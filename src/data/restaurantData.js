...
export const reviewsData = [
  ...
  { name: "Simone Trombetta", date: "Novembre 2022", rating: 5, text: "Sono stato a cena in compagnia di amici e mi sono sentito a casa. Cucina tipica romana, ma di quella vera!! Esci dal locale più che satollo!! E spendi il giusto. Da riandare" },
  { name: "Dr. Quirino Mastronardi", date: "2 anni fa", rating: 4, text: "Sfatiamo, non è una cucina Romana, tutt' altro, dovete avere pazienza, la cucina è lenta ma cibi di ottima scelta." },
  { name: "Pasquale Monterotti", date: "3 anni fa", rating: 4, text: "L'entrata non rende l'idea,poi dentro e tutta un altra cosa Alessandro e la madre ci accolgono ,e la ragazza ci accompagna nella saletta dove mangiamo . Il posto è veramente carino e sembra distare a casa tua ,la ragazza che ci serve e simpatica e il cibo e veramente buono. Bucatini all'amatriciana ottimi ed abbondanti ,carne cotta al punto giusto e buona....ci siamo trovati veramente bene, addirittura se vuoi qualcosa di particolare puoi chiamarli e chiederla.. lo lo consiglio qualità e prezzo eccezionali." }
];
