...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ease-out border-b ${scrolled ? 'bg-black/80 backdrop-blur-md border-white/10 py-4 shadow-2xl' : 'bg-transparent border-transparent py-6'}`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
